...
<div class="content-wrapper">
	<a href="<?php echo base_url("member/rapor/form"); ?>" class="btn btn-info">UNGGAH DATA</a>
	<a href="<?php echo base_url("member/rapor/export"); ?>" class="btn btn-info">REKAP DATA</a>
