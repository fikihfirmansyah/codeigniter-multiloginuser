...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active"><a href="<?= base_url() ?>"><i class="fa fa-dashboard"></i> <span>Beranda</span></a></li>
      <li><a href="<?= base_url('/rapor') ?>"><i class="fa fa-users"></i> <span>Rapor</span></a></li>

      <li><a href="<?= base_url('/admin/person') ?>"><i class="fa fa-users"></i> <span>Pengguna</span></a></li>
